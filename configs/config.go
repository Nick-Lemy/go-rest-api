...
import (
	...
	"github.com/yourGithubUsername/gin-rest-tutorial/internal/app/rest_api/constants"
)
...
func NewConfig() *Config {
	...
	c := &Config{
		Server: serverConfig{
			Address: GetEnvOrPanic(constants.EnvKeys.ServerAdress),
		},
		Database: databaseConfig{
			DatabaseDriver: GetEnvOrPanic(constants.EnvKeys.DBDriver),
			DatabseSource:  GetEnvOrPanic(constants.EnvKeys.DBSource),
		},
	}
	return c
}
